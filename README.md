...
<table align="center" style="border-collapse: collapse; width: 80%; margin: 0 auto;">
  <tr>
    <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;">Technology</th>
    <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;">Description</th>
  </tr>
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">SwiftUI</td>
    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">Building modern user interfaces for iOS apps.</td>
  </tr>
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">Combine</td>
    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">Handling asynchronous events and data streams.</td>
  </tr>
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">UIKit</td>
    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">Creating user interfaces for iOS applications.</td>
  </tr>
  <tr>
    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">Production-Ready Apps</td>
    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">Learning best practices for deploying apps to the App Store.</td>
  </tr>
</table>
...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=SaishTiw iwari" alt="GitHub Streak" />
</p>
